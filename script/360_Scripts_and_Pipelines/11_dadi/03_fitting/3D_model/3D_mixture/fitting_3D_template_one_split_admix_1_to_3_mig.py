...
# Load the data
data = dadi.Spectrum.from_file('xxxxfs')
data=data.fold()
...
func = demographic_models.three_pop_one_split_admix_1_to_3_mig
# ll for this model: -1136.61
params = array([0.01,0.01,0.001,0.001,0.001,0.01,0.01,0.01,0.01])
