...
parser.add_argument('-i3', type = argparse.FileType('r'), help = 'Divergence genes file')
...
def Extractfst(input1, input2, input3, output):
...
if __name__ == "__main__":
	Extractfst(args.i1, args.i2, args.i3, args.o)
	args.i1.close()
	args.i2.close()
	args.i3.close()
	args.o.close()
