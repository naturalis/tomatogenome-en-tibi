...
die "perl $0 <Chr> <Len> <Cult> <Wild> <window> \n" if($#ARGV<3);
my $chr=shift;
my $len=shift;
my $cult=shift;
my $wild=shift;
...
my $genotype="/share/fg2/lintao/solab/lintao/tomato/FST/zhang/08_selection/04_Fst/genotype/$chr.final.genotype";
